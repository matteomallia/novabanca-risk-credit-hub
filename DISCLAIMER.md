...
- I documenti della Knowledge Base (`backend/docs/`) sono testi scritti a
  scopo dimostrativo e **non rappresentano policy o procedure realmente in
  vigore** presso alcun istituto bancario.

## Uso previsto

Il codice è pensato per essere eseguito in locale o su un ambiente di test
controllato, con una chiave API OpenAI personale. **Non è pensato per un uso
in produzione** con dati reali di clienti o informazioni sensibili, senza
un'ulteriore revisione di sicurezza, conformità normativa (GDPR, normative
bancarie) e un audit approfondito.
